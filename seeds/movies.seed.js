...
async function testMovieCreationAndDeletion() {
    // Movie.deleteMany()
    console.log('Count of movie', await Movie.count())
    const createdMovie = await Movie.create(movies)

    console.log(createdMovie)
    console.log('Count of movies', await Movie.count())

    console.log('Count of movies', await Movie.count())
}

mongoose.connect('http://localhost:27017/lab-express-cinema', async () => {
    console.log('Connected to Database via http')
    await testMovieCreationAndDeletion()
